...
const Thumbnailupload = require('../../models/thumbnailupload.model'); // Adjust the path based on your project structure
...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    const newUpload = new Thumbnailupload({
    ...
    return responder.success(res, { thumbnail_id: savedUpload._id, imagePath });
  } catch (error) {
