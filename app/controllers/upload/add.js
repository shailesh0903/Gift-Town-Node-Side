...
const Upload = require('../../models/upload.model'); // Adjust the path based on your project structure
...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    return responder.success(res, { imageId: savedUpload._id, imagePath });
  } catch (error) {
